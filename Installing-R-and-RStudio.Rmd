...
> "RStudio is dedicated to sustainable investment in free and open-source software for data science." Source: <https://posit.co>

-   Installing R and RStudio is FREE.
-   It is a two-step process and **the order that you do the steps is important!**
...
-   Clink on the link
-   Choose to Download Raw.
-   From RStudio, choose `File -> Open File` and select the appropriate file location.
