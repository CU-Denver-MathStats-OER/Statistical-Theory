...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://githubtocolab.com/CU-Denver-MathStats-OER/Statistical-Theory/blob/main/Chap1/02-EDA-Categorical.ipynb) <nbsp>
...
- See [Fundamentals of Working with Data](Intro-to-Vectors-Dataframes.qmd) for further details about data types and structures in R.
...
-   If a variable groups observations into different categories or rankings, it is a <span style="color:dodgerblue">**qualitative**</span> or <span style="color:dodgerblue">**categorical**</span> variable.
  ...
  - Levels may be labeled as character strings without any implicit order.
  - Levels may be labeled as character strings, and there may be a ranking of the levels.
  - Levels may be labeled with a integer without any implicit order.
  - Levels may be labeled with an integer that does indicate an order or ranking. 
...
-   One common issue is categorical data is stored as characters or integers. We would like observations with the same values to be group together.
...
- <span style="color:dodgerblue">**Typically with categorical data, we prefer to count how many observations are in each class of the variable.**</span>
...
The data set `gss_cat` can be accessed from the `forcats` package. Below is a quote taken from the website of the [GSS Data Explorer website](https://gssdataexplorer.norc.org/about) maintained by NORC at the University of Chicago
