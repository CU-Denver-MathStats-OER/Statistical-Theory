...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://githubtocolab.com/CU-Denver-MathStats-OER/Statistical-Theory/blob/main/Chap2/06-Expected-Value-and-Variance.ipynb) <nbsp>
...
Additional Reference: See [Introduction to Random Variables](05-Intro-to-Random-Variables.qmd) where we discovered some important properties for a random variable $X$ that are summarized in the [Appendix: Properties of Random Variables].
...
In [Introduction to Random Variables](https://githubtocolab.com/CU-Denver-MathStats-OER/Statistical-Theory/blob/main/Chap2/05-Intro-to-Random-Variables.ipynb) we discovered the following properties for a random variable $X$.
