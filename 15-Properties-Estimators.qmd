...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://githubtocolab.com/CU-Denver-MathStats-OER/Statistical-Theory/blob/main/Chap4/15-Properties-Estimators.ipynb) <nbsp>
...
::: {.callout-tip}
Use [properties of expected value](06-Expected-Value-and-Variance.qmd#sec-prop-exp) and recall these useful formulas for $X \sim \mbox{Binom}(n,p)$,
...
::: {.callout-tip}
Recall properties we can apply when finding the [variance of a linear combination of independent random variables](06-Expected-Value-and-Variance.qmd#sec-prop-var), and note **the variances will depend on the unknown value of the population variance,** $\mathbf{\sigma^2}$.
:::
...
::: {.callout-tip}
Use [properties of variance](06-Expected-Value-and-Variance.qmd#sec-prop-var) and recall these useful formulas for $X \sim \mbox{Binom}(n,p)$,
