...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://githubtocolab.com/CU-Denver-MathStats-OER/Statistical-Theory/blob/main/Chap2/04-Overview-of-Probability.ipynb) <nbsp>
...
-   $\color{dodgerblue}{P(A \cup B)}$ is the probability that either event $A$ <span style="color:dodgerblue">**or**</span> event $B$ occurs.
