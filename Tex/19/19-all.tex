...
\begin{center}
\includegraphics[width=0.95\tw]{10/fig-meal-permutation.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.75\tw]{10/fig-wings-table.png}
\end{center}
...
%\end{lstlisting}
%%\includegraphics[width=0.85\tw]{10/fig-delay-prop-code.png}
...
\includegraphics[width=0.35\tw]{10/fig-phelps.jpg}
...
\end{lstlisting}
%\ii library(resampledata)
%\ii target $<-$ Groceries$\$$Target
%\ii walmart $<-$ Groceries$\$$Walmart
%\ei
